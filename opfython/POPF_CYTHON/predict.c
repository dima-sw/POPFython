...
static PyObject *__pyx_f_7predict_predict(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_7predict_work(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int); /*proto*/
static void __pyx_f_7predict_creaTagli(int *, int *, int, int); /*proto*/
...
static const char __pyx_k_ordered_nodes[] = "ordered_nodes";
...
static const char __pyx_k_Parallel_classification_Author[] = "\nParallel classification\n\n@Author: Dmytro Lysyhanych\n\n";
...
static PyObject *__pyx_n_s_ordered_nodes;
...
static PyObject *__pyx_pf_7predict_predict(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_predicted_label, __Pyx_memviewslice __pyx_v_ordered_nodes, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_val_feat, __Pyx_memviewslice __pyx_v_P2, __Pyx_memviewslice __pyx_v_L2, int __pyx_v_n_Threads); /* proto */
...
static PyObject *__pyx_pw_7predict_1predict(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7predict_predict(__Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_predicted_label, __Pyx_memviewslice __pyx_v_ordered_nodes, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_val_feat, __Pyx_memviewslice __pyx_v_P2, __Pyx_memviewslice __pyx_v_L2, int __pyx_v_n_Threads, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_f_len;
  int __pyx_v_nodes_len;
  int *__pyx_v_R1;
  int *__pyx_v_R2;
  int __pyx_v_i;
 ...
 */
  __pyx_t_1.data = __pyx_v_features.data;
  __pyx_t_1.memview = __pyx_v_features.memview;
...
__pyx_t_1.shape[0] = __pyx_v_features.shape[1];
__pyx_t_1.strides[0] = __pyx_v_features.strides[1];
 ...
 */
  __pyx_t_2 = __Pyx_MemoryView_Len(__pyx_v_features); 
  __pyx_v_nodes_len = __pyx_t_2;
 ...
 * 	with nogil,parallel():
 */
  __pyx_t_2 = __Pyx_MemoryView_Len(__pyx_v_val_feat); 
  __pyx_f_7predict_creaTagli(__pyx_v_R1, __pyx_v_R2, __pyx_v_n_Threads, __pyx_t_2);
 ...
 * 
 */
                                __pyx_f_7predict_work(__pyx_v_cost, __pyx_v_predicted_label, __pyx_v_ordered_nodes, __pyx_v_features, __pyx_v_val_feat, __pyx_v_P2, __pyx_v_L2, __pyx_v_f_len, __pyx_v_nodes_len, (__pyx_v_R1[__pyx_v_i]), (__pyx_v_R2[__pyx_v_i]));
                            }
                        }
                    }
                }
...
/* Python wrapper */
static PyObject *__pyx_pw_7predict_1predict(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_7predict_1predict(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_cost = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_predicted_label = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_ordered_nodes = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_features = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_val_feat = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_cost,&__pyx_n_s_predicted_label,&__pyx_n_s_ordered_nodes,&__pyx_n_s_features,&__pyx_n_s_val_feat,&__pyx_n_s_P2,&__pyx_n_s_L2,&__pyx_n_s_n_Threads,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_predicted_label)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 1); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_ordered_nodes)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 2); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_features)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 3); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_val_feat)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 4); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_P2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 5); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_L2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 6); __PYX_ERR(0, 17, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n_Threads)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, 7); __PYX_ERR(0, 17, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "predict") < 0)) __PYX_ERR(0, 17, __pyx_L3_error)
      }
    ...
    __pyx_v_cost = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_cost.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_predicted_label = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_predicted_label.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_ordered_nodes = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_ordered_nodes.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_features = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_features.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_val_feat = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_val_feat.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_P2 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_P2.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_L2 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_L2.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
    __pyx_v_n_Threads = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_n_Threads == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 17, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("predict", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 17, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("predict.predict", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7predict_predict(__pyx_self, __pyx_v_cost, __pyx_v_predicted_label, __pyx_v_ordered_nodes, __pyx_v_features, __pyx_v_val_feat, __pyx_v_P2, __pyx_v_L2, __pyx_v_n_Threads);
...
static PyObject *__pyx_pf_7predict_predict(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_predicted_label, __Pyx_memviewslice __pyx_v_ordered_nodes, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_val_feat, __Pyx_memviewslice __pyx_v_P2, __Pyx_memviewslice __pyx_v_L2, int __pyx_v_n_Threads) {
  ...
  if (unlikely(!__pyx_v_cost.memview)) { __Pyx_RaiseUnboundLocalError("cost"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_predicted_label.memview)) { __Pyx_RaiseUnboundLocalError("predicted_label"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_ordered_nodes.memview)) { __Pyx_RaiseUnboundLocalError("ordered_nodes"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_features.memview)) { __Pyx_RaiseUnboundLocalError("features"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_val_feat.memview)) { __Pyx_RaiseUnboundLocalError("val_feat"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_P2.memview)) { __Pyx_RaiseUnboundLocalError("P2"); __PYX_ERR(0, 17, __pyx_L1_error) }
  if (unlikely(!__pyx_v_L2.memview)) { __Pyx_RaiseUnboundLocalError("L2"); __PYX_ERR(0, 17, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_7predict_predict(__pyx_v_cost, __pyx_v_predicted_label, __pyx_v_ordered_nodes, __pyx_v_features, __pyx_v_val_feat, __pyx_v_P2, __pyx_v_L2, __pyx_v_n_Threads, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 17, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_predicted_label, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_ordered_nodes, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_features, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_val_feat, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_P2, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_L2, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static void __pyx_f_7predict_ww(CYTHON_UNUSED __Pyx_memviewslice __pyx_v_cost, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_predicted_label, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_ordered_nodes, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_features, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_val_feat, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_P2, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_L2, CYTHON_UNUSED int __pyx_v_f_len, CYTHON_UNUSED int __pyx_v_nodes_len, CYTHON_UNUSED int __pyx_v_r1, CYTHON_UNUSED int __pyx_v_r2, CYTHON_UNUSED int __pyx_v_i) {
...
static void __pyx_f_7predict_work(__Pyx_memviewslice __pyx_v_cost, __Pyx_memviewslice __pyx_v_predicted_label, __Pyx_memviewslice __pyx_v_ordered_nodes, __Pyx_memviewslice __pyx_v_features, __Pyx_memviewslice __pyx_v_val_feat, __Pyx_memviewslice __pyx_v_P2, __Pyx_memviewslice __pyx_v_L2, int __pyx_v_f_len, int __pyx_v_nodes_len, int __pyx_v_r1, int __pyx_v_r2) {
  int __pyx_v_j;
  int __pyx_v_i;
  int __pyx_v_k;
  int __pyx_v_l;
 ...
 */
    __pyx_t_4 = __pyx_v_j;
    __pyx_v_k = (*((long *) ( /* dim=0 */ (__pyx_v_ordered_nodes.data + __pyx_t_4 * __pyx_v_ordered_nodes.strides[0]) )));
 ...
 */
      ...
      __pyx_v_dist = (__pyx_v_dist + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_features.data + __pyx_t_4 * __pyx_v_features.strides[0]) ) + __pyx_t_8 * __pyx_v_features.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_val_feat.data + __pyx_t_9 * __pyx_v_val_feat.strides[0]) ) + __pyx_t_10 * __pyx_v_val_feat.strides[1]) )))) * ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_features.data + __pyx_t_11 * __pyx_v_features.strides[0]) ) + __pyx_t_12 * __pyx_v_features.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_val_feat.data + __pyx_t_13 * __pyx_v_val_feat.strides[0]) ) + __pyx_t_14 * __pyx_v_val_feat.strides[1]) ))))));
    }
 ...
 */
    ...
    __pyx_t_15 = (((*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_14 * __pyx_v_cost.strides[0]) ))) > __pyx_v_dist) != 0);
    if (__pyx_t_15) {
 ...
 */
      __pyx_t_14 = __pyx_v_k;
      __pyx_v_min_cost = (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_14 * __pyx_v_cost.strides[0]) )));
 ...
 */
    __pyx_t_14 = __pyx_v_k;
    __pyx_v_current_label = (*((long *) ( /* dim=0 */ (__pyx_v_predicted_label.data + __pyx_t_14 * __pyx_v_predicted_label.strides[0]) )));
 ...
 */
    while (1) {
      __pyx_t_16 = ((__pyx_v_j < (__pyx_v_nodes_len - 1)) != 0);
      if (__pyx_t_16) {
      } else {
      ...
      __pyx_t_13 = (*((long *) ( /* dim=0 */ (__pyx_v_ordered_nodes.data + __pyx_t_14 * __pyx_v_ordered_nodes.strides[0]) )));
      __pyx_t_16 = ((__pyx_v_min_cost > (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_13 * __pyx_v_cost.strides[0]) )))) != 0);
      __pyx_t_15 = __pyx_t_16;
 ...
 */
      __pyx_t_14 = (__pyx_v_j + 1);
      __pyx_v_l = (*((long *) ( /* dim=0 */ (__pyx_v_ordered_nodes.data + __pyx_t_14 * __pyx_v_ordered_nodes.strides[0]) )));
 ...
 */
        ...
        __pyx_t_8 = __pyx_v_i;
        __pyx_t_4 = __pyx_v_z;
        __pyx_v_dist = (__pyx_v_dist + (((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_features.data + __pyx_t_14 * __pyx_v_features.strides[0]) ) + __pyx_t_13 * __pyx_v_features.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_val_feat.data + __pyx_t_12 * __pyx_v_val_feat.strides[0]) ) + __pyx_t_11 * __pyx_v_val_feat.strides[1]) )))) * ((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_features.data + __pyx_t_10 * __pyx_v_features.strides[0]) ) + __pyx_t_9 * __pyx_v_features.strides[1]) ))) - (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_val_feat.data + __pyx_t_8 * __pyx_v_val_feat.strides[0]) ) + __pyx_t_4 * __pyx_v_val_feat.strides[1]) ))))));
      }
 ...
 */
      __pyx_t_4 = __pyx_v_l;
      __pyx_t_15 = (((*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_4 * __pyx_v_cost.strides[0]) ))) > __pyx_v_dist) != 0);
      if (__pyx_t_15) {
 ...
 */
        __pyx_t_4 = __pyx_v_l;
        __pyx_v_tmp_cost = (*((double *) ( /* dim=0 */ (__pyx_v_cost.data + __pyx_t_4 * __pyx_v_cost.strides[0]) )));
 ...
 * 				conqueror=l
 */
      __pyx_t_15 = ((__pyx_v_tmp_cost < __pyx_v_min_cost) != 0);
      if (__pyx_t_15) {
 ...
 */
        __pyx_v_min_cost = __pyx_v_tmp_cost;
 ...
 */
        __pyx_t_4 = __pyx_v_l;
        __pyx_v_current_label = (*((long *) ( /* dim=0 */ (__pyx_v_predicted_label.data + __pyx_t_4 * __pyx_v_predicted_label.strides[0]) )));
 ...
 * 		P2[p_indx]=conqueror
 */
    __pyx_t_4 = __pyx_v_p_indx;
    *((long *) ( /* dim=0 */ (__pyx_v_L2.data + __pyx_t_4 * __pyx_v_L2.strides[0]) )) = __pyx_v_current_label;
 ...
 */
    __pyx_t_4 = __pyx_v_p_indx;
    *((long *) ( /* dim=0 */ (__pyx_v_P2.data + __pyx_t_4 * __pyx_v_P2.strides[0]) )) = __pyx_v_conqueror;
 ...
 * 
 */
    __pyx_v_p_indx = (__pyx_v_p_indx + 1);
  }
...
static void __pyx_f_7predict_creaTagli(int *__pyx_v_R1, int *__pyx_v_R2, int __pyx_v_nTagli, int __pyx_v_n_nodes) {
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
 ...
 */
    /*else*/ {
      __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_i); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 114, __pyx_L1_error)
      ...
      __pyx_t_6 = __Pyx_PyInt_From_int(__Pyx_div_int(__pyx_v_n_nodes, __pyx_v_nTagli)); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 114, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_PyObject_CallOneArg(((PyObject *)(&PyInt_Type)), __pyx_t_6); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 114, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyNumber_Multiply(__pyx_t_5, __pyx_t_7); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 114, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
      __pyx_t_8 = __Pyx_PyInt_As_int(__pyx_t_6); if (unlikely((__pyx_t_8 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 114, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("predict.creaTagli", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "predict._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"predict", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_7predict_1predict, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "predict",
    __pyx_k_Parallel_classification_Author, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_ordered_nodes, __pyx_k_ordered_nodes, sizeof(__pyx_k_ordered_nodes), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("predict", __pyx_methods, __pyx_k_Parallel_classification_Author, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
 ...
 */
  ...
  __pyx_t_2 = __Pyx_Import(__pyx_n_s_opfython_Sequential_supervised_d, __pyx_t_1, -1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_ImportFrom(__pyx_t_2, __pyx_n_s_distancescy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);

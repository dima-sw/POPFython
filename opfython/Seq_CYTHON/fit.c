...
static PyObject *__pyx_f_3fit_fit(PyObject *, PyObject *, __Pyx_memviewslice, float, int __pyx_skip_dispatch); /*proto*/
static int __pyx_f_3fit_work(__Pyx_memviewslice, int, int, int *, int *, int *, double *, int); /*proto*/
static float __pyx_f_3fit_squared_euclidean_distance(__Pyx_memviewslice, __Pyx_memviewslice, int); /*proto*/
...
static PyObject *__pyx_pf_3fit_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nodes, PyObject *__pyx_v_idx_nodes, __Pyx_memviewslice __pyx_v_features, float __pyx_v_Max_Cost); /* proto */
...
static PyObject *__pyx_f_3fit_fit(PyObject *__pyx_v_nodes, PyObject *__pyx_v_idx_nodes, __Pyx_memviewslice __pyx_v_features, float __pyx_v_Max_Cost, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_size;
  int *__pyx_v_P;
  int *__pyx_v_L;
  int *__pyx_v_U;
...
__pyx_t_1 = __Pyx_MemoryView_Len(__pyx_t_2); 
  ...
  __pyx_t_2.data = NULL;
  __pyx_t_3 = __Pyx_PyInt_FromSize_t(__pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 24, __pyx_L1_error)
 ...
 * 			P[i]=-1
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_status); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_PyInt_EqObjC(__pyx_t_7, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 29, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
 ...
 * 			if flag==0:
 */
      __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_label); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_9 = __Pyx_PyInt_As_int(__pyx_t_7); if (unlikely((__pyx_t_9 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 33, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 * 
 */
      __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_7);
      __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_pred); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 40, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 * 
 */
    __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_s); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_10 = __Pyx_PyObject_Append(__pyx_v_idx_nodes, __pyx_t_3); if (unlikely(__pyx_t_10 == ((int)-1))) __PYX_ERR(0, 47, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
    __pyx_t_3 = PyFloat_FromDouble((__pyx_v_C[__pyx_v_s])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_s, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    if (__Pyx_PyObject_SetAttrStr(__pyx_t_7, __pyx_n_s_cost, __pyx_t_3) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
 ...
 * 
 */
    __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_v_lun); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 50, __pyx_L1_error)
    __pyx_v_s = __pyx_f_3fit_work(__pyx_v_features, __pyx_v_s, __pyx_v_size, __pyx_v_U, __pyx_v_L, __pyx_v_P, __pyx_v_C, __pyx_t_4);
  }
 ...
 * 
 */
    __pyx_t_7 = __Pyx_PyInt_From_int((__pyx_v_P[__pyx_v_i])); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (__Pyx_PyObject_SetAttrStr(__pyx_t_3, __pyx_n_s_pred, __pyx_t_7) < 0) __PYX_ERR(0, 57, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 * 	free(P)
 */
    __pyx_t_3 = __Pyx_PyInt_From_int((__pyx_v_L[__pyx_v_i])); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_7 = __Pyx_GetItemInt(__pyx_v_nodes, __pyx_v_i, int, 1, __Pyx_PyInt_From_int, 0, 0, 0); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_7);
    if (__Pyx_PyObject_SetAttrStr(__pyx_t_7, __pyx_n_s_predicted_label, __pyx_t_3) < 0) __PYX_ERR(0, 58, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  }
...
static PyObject *__pyx_pw_3fit_1fit(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nodes,&__pyx_n_s_idx_nodes,&__pyx_n_s_features,&__pyx_n_s_Max_Cost,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_idx_nodes)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("fit", 1, 4, 4, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_features)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit", 1, 4, 4, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_Max_Cost)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("fit", 1, 4, 4, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "fit") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_features = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_features.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_Max_Cost = __pyx_PyFloat_AsFloat(values[3]); if (unlikely((__pyx_v_Max_Cost == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("fit", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("fit.fit", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3fit_fit(__pyx_self, __pyx_v_nodes, __pyx_v_idx_nodes, __pyx_v_features, __pyx_v_Max_Cost);
...
static PyObject *__pyx_pf_3fit_fit(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nodes, PyObject *__pyx_v_idx_nodes, __Pyx_memviewslice __pyx_v_features, float __pyx_v_Max_Cost) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_features.memview)) { __Pyx_RaiseUnboundLocalError("features"); __PYX_ERR(0, 13, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_3fit_fit(__pyx_v_nodes, __pyx_v_idx_nodes, __pyx_v_features, __pyx_v_Max_Cost, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
...
static int __pyx_f_3fit_work(__Pyx_memviewslice __pyx_v_features, int __pyx_v_s, int __pyx_v_size, int *__pyx_v_U, int *__pyx_v_L, int *__pyx_v_P, double *__pyx_v_C, int __pyx_v_lun) {
  int __pyx_v_t;
...
__pyx_t_7 = PyFloat_FromDouble(__pyx_f_3fit_squared_euclidean_distance(__pyx_t_5, __pyx_t_6, __pyx_v_lun)); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 80, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
 ...
 * 				else:
 */
        __pyx_t_7 = PyFloat_FromDouble((__pyx_v_C[__pyx_v_s])); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 82, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_7);
        __pyx_t_8 = PyObject_RichCompare(__pyx_t_7, __pyx_v_dist, Py_GE); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 82, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
        __pyx_t_4 = __Pyx_PyObject_IsTrue(__pyx_t_8); if (unlikely(__pyx_t_4 < 0)) __PYX_ERR(0, 82, __pyx_L1_error)
 ...
 */
        /*else*/ {
          __pyx_t_9 = __pyx_PyFloat_AsDouble(__pyx_v_dist); if (unlikely((__pyx_t_9 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 85, __pyx_L1_error)
          __pyx_v_curr_cost = __pyx_t_9;
        }
        __pyx_L7:;
 ...
 */
      ...
      __pyx_t_10 = (((__pyx_v_C[__pyx_v_s1]) > (__pyx_v_C[__pyx_v_t])) != 0);
      __pyx_t_4 = __pyx_t_10;
 ...
 */
  ...
  __Pyx_WriteUnraisable("fit.work", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static float __pyx_f_3fit_squared_euclidean_distance(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_y, int __pyx_v_lun) {
  int __pyx_v_i;
  float __pyx_v_dist;
  float __pyx_r;
  __Pyx_RefNannyDeclarations
